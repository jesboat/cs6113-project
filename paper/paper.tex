...
noninterference for a simple language with security labels on the types.
Although we did not complete the full proof because we ran out of time, we were
able to find small inaccuracies and subtleties in the proofs from the paper we
based our proof on.  We discuss what would be involved in completing the proof
and how this relates to other work.
