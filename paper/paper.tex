...
Given the growing popularity of Proof Assistants information-flow languages, we
were surprised to discover that there has not been work done to formalize ad
...
\begin{description}
  \item[Non-nesting Brackets in Syntax]
    ...
    Lemma from being proveable.  Realizing that our definitions did not disallow
...
Once our noninterference proof has been sucessfully mechanized for \langName, we
will incrementally enhance the features of \langName, adding in absent
