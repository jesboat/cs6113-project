...
correct, errors to creep into even the most scrutinized of paper results (as we have observed in this project), and so requiring these extensions to come with mechanized proofs of correctness before incorporation into a verified compiler would help ensure that the language updates will not invalidate pre-existing security
